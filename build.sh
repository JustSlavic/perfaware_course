...
as ../code/04_test_decoding_bottleneck.arm64 -o 04_asm.o
gcc $C_FLAGS -O1 $WARNINGS $DEFINES $INCLUDES -o 04_test_decoding_bottleneck ../code/04_test_decoding_bottleneck.c 04_asm.o
